...
<div class="form-group">
  <label class="col-md-4 control-label" for="Training">Would you like to Subscribe our channel?</label>
  <div class="col-md-4"> 
    <label class="radio-inline" for="Subscribe-0">
      <input type="radio" name="Subscribe" id="Subscribe-0" value="yes" checked="checked">
      Yes
    </label> 
    <label class="radio-inline" for="Subscribe-1">
      <input type="radio" name="Subscribe" id="Subscribe-1" value="no">
      No
    </label>
  </div>
</div>
